document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
            ...
            if (isValid) {
                ...
                .then(response => {
                    if (response.ok) {
                        ...
                        successMsg.style.cssText = 'color: #38a169; background: #f0fff4; padding: 1rem; border-radius: 0.375rem; margin-top: 1rem; text-align: center;';
                ...
                .catch(() => {
                    ...
                    errorMsg.style.cssText = 'color: #e53e3e; background: #fff5f5; padding: 1rem; border-radius: 0.375rem; margin-top: 1rem; text-align: center;';
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.closest && (input.matches('[name="name"], #name') || 
                input.matches('[name="email"], #email') || 
                input.matches('[name="phone"], #phone') || 
                input.matches('[name="message"], #message'))) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4f21017a-2ec5-4e84-9708-268070f53968',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4f21017a-2ec5-4e84-9708-268070f53968';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4f21017a-2ec5-4e84-9708-268070f53968';
